...
import { Check, TrendingUp, Award, Headphones } from 'lucide-react'
  ...
  return (
    <section id="franchise" className="py-8 lg:py-16 bg-silk-white relative overflow-hidden">
      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-12 relative">
          ...
          {benefits.map((benefit, index) => (
            ...
            >
              <div className="w-14 h-14 bg-tea-ink flex items-center justify-center mb-6">
                <benefit.icon className="w-6 h-6 text-tea-sage" />
              </div>
        ...
        >
          <h3 className="font-serif text-3xl lg:text-4xl text-silk-white mb-4">準備好開啟茶事業了嗎？</h3>
          <p className="text-silk-white/50 mb-10 max-w-2xl mx-auto">
            歡迎與我們聯繫，了解更多加盟詳情。我們期待與您一起創造美好的茶文化體驗。
          </p>
